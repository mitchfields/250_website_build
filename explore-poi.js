...
// Attribution data from the compliance image source list (CREDITS_and_LICENSES.csv)
// and ATTRIBUTION_HOWTO.txt. Structured so the panel can render a viewer-visible
// credit that carries everything the licenses require:
//   author     — photographer/artist name, links to the Commons file page
//   license    — human-readable license name (e.g. "CC BY-SA 4.0")
//   licenseUrl — link to the license deed (null for public-domain / custom tags)
//   source     — the Commons file page
//   req        — true when the license (CC BY / BY-SA / Attribution) makes the
//                credit mandatory; false for public-domain / CC0 courtesy credits
// author is null for public-domain files, which are credited without a byline.
const CRED = {
  1: { author: 'John Mackenzie Burke', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Taos_Pueblo_2017-05-05.jpg', req: true },
  2: { author: 'Beyond My Ken', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:2017_Paul_Revere_House_from_east.jpg', req: true },
  3: { author: 'ajay_suresh', license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', source: 'https://commons.wikimedia.org/wiki/File:Betsy_Ross_House_(53572939795).jpg', req: true },
  4: { author: 'Moofpocket', license: 'CC BY 2.5', licenseUrl: 'https://creativecommons.org/licenses/by/2.5', source: 'https://commons.wikimedia.org/wiki/File:Monticello_reflected.JPG', req: true },
  5: { author: 'Goingstuckey', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Drayton_Hall_2007.jpg', req: true },
  6: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Jacob_Dingee_House.JPG', req: false },
  8: { author: 'JGHowes (Canon AE-1, Kodachrome)', license: 'Attribution', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Hampton_Natl_Historic_Site.jpg', req: true },
  9: { author: 'Daniel Schwen', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Lincoln_Home_1.jpg', req: true },
  10: { author: 'Ammodramus', license: 'CC0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0', source: 'https://commons.wikimedia.org/wiki/File:Cordova_house_(Tucson,_Arizona)_from_SE_1.JPG', req: false },
  11: { author: 'Beneathtimp', license: 'CC0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0', source: 'https://commons.wikimedia.org/wiki/File:Beehive_House_-_Salt_Lake_City,_Utah_-_2_May_2020.jpg', req: false },
  12: { author: 'Bubba73 (Jud McCranie)', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Johnston%E2%80%93Felton%E2%80%93Hay_House,_Macon,_GA,_US.jpg', req: true },
  13: { author: 'Chris Light', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Main_House_052.jpg', req: true },
  14: { author: 'Antony-22', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Malden_Historic_District_2021a.jpg', req: true },
  16: { author: 'Makemake (German Wikipedia)', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:House_of_Mark_Twain.jpg', req: true },
  18: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Frederick_Douglass_House.jpg', req: false },
  19: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Willa_Cather_house_from_NE_3.JPG', req: false },
  20: { author: 'P. Hughes', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Glenmont_estate.jpg', req: true },
  21: { author: 'Antony-22', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:The_Hermitage_cabins_2022a.jpg', req: true },
  22: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:2007-06-04-Gothic_House.jpg', req: false },
  24: { author: 'Magicpiano', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:ScarboroughME_WinslowHomerStudio.jpg', req: true },
  25: { author: 'Ser Amantio di Nicolao', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Saint-Gaudens_National_Historic_Site_-_Aspet_front_from_green.JPG', req: true },
  26: { author: 'Calstanhope', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Helen_Keller_Birthplace_House_in_Tuscumbia,_Alabama.jpg', req: true },
  27: { author: 'Self', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Molly_Brown_House.JPG', req: true },
  28: { author: 'BakedintheHole', license: 'CC BY 4.0', licenseUrl: 'https://creativecommons.org/licenses/by/4.0', source: 'https://commons.wikimedia.org/wiki/File:The_Barnacle_in_Miami.jpg', req: true },
  29: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Marble_House,_Newport_RI.jpg', req: false },
  30: { author: 'Blake Lewis', license: 'CC BY-SA 2.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.0', source: 'https://commons.wikimedia.org/wiki/File:Biltmore_Estate,_2012.jpg', req: true },
  31: { author: 'Staryu', license: 'CC0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0', source: 'https://commons.wikimedia.org/wiki/File:Eisenhower_Home_in_2026.png', req: false },
  32: { author: 'Jerrye & Roy Klotz MD', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:LUDWIG_AND_CHRISTINA_WELK_HOMESTEAD.jpg', req: true },
  33: { author: 'Fletcher6', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:97_Orchard_Street_Front.jpg', req: true },
  34: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Glensheen.JPG', req: false },
  35: { author: 'J Hirtle', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Prairie_Homestead_IMG_0067.jpg', req: true },
  36: { author: 'Teemu08', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Frederick_C._Robie_House.JPG', req: true },
  37: { author: 'Warren LeMay', license: 'CC BY-SA 2.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.0', source: 'https://commons.wikimedia.org/wiki/File:Taliesin_exterior_2024_(54225850259).jpg', req: true },
  39: { author: 'TimothyMN', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:LauraIngallsWilder-RockyRidgeFarm-MansfieldMO_adjusted.jpg', req: true },
  41: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Edward_Schulmerich_House_2008.JPG', req: false },
  42: { author: 'King of Hearts', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Hearst_Castle_Casa_Grande_September_2012_panorama_2.jpg', req: true },
  43: { author: 'Wm. Chris Rowland, II', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Meadowbrook_Hall.JPG', req: true },
  45: { author: 'Seattle Municipal Archives', license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', source: 'https://commons.wikimedia.org/wiki/File:Seattle_-_Houseboats_on_Lake_Union,_circa_1970s_(36910759450).jpg', req: true },
  46: { author: 'Blake Everett Carroll', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:Thunderbird_Lodge,_Lake_Tahoe,_Nevada,_20220905,_03.jpg', req: true },
  51: { author: 'Valis55', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0', source: 'https://commons.wikimedia.org/wiki/File:Daisy_Bates_House.JPG', req: true },
  53: { author: null, license: 'Public domain', licenseUrl: null, source: 'https://commons.wikimedia.org/wiki/File:Miller_House_in_Columbus.jpg', req: false },
  54: { author: 'altiemae', license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', source: 'https://commons.wikimedia.org/wiki/File:Hemingway_Memorial_Sun_Valley.jpg', req: true },
  56: { author: "IK's World Trip", license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', source: 'https://commons.wikimedia.org/wiki/File:Gehry_House_-_Image01.jpg', req: true },
  59: { author: 'WASP / Mario Cucinella Architects', license: 'CC BY 2.5', licenseUrl: 'https://creativecommons.org/licenses/by/2.5', source: 'https://commons.wikimedia.org/wiki/File:Eco-sustainable_3D_printed_house_%22Tecla%22.jpg', req: true },
};
